...
public class TopGainers{
	...
	//Function for excluding weekends from the given number of days
	...
	public List<HistoricalQuote> fetchHistoricData(String symbol)
	{
	    ...
	    to.add(cal1.DATE,-1);
     	...
     	try {
     		...
     		history =  YahooFinance.get(symbol).getHistory(from, to, Interval.WEEKLY);
	...
	//Extracting closing price for each company from its historical data
	...
	//Fetching top gainers for each sector
